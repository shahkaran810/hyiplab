        ...
        <div class="container">
            <nav class="navbar navbar-expand-xl p-0 align-items-center">
                ...
                <ul class="account-menu responsive-account-menu ms-3">
                    @guest
                        <li class="btn--base text-uppercase font-weight-200 mt-4"><a href="{{ route('user.login') }}">@lang('Login')</a></li>
                        <li class="btn--base text-uppercase font-weight-200 mt-4"><a href="{{ route('user.register') }}">@lang('SIGN UP')</a></li>
